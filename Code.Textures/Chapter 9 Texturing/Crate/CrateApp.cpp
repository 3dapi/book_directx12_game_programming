...
void CrateApp::Draw(const GameTimer& gt)
{
    ...
    ThrowIfFailed(m_d3dCommandList->Reset(cmdListAlloc.Get(), mOpaquePSO.Get()));
...
void CrateApp::LoadTextures()
{
	...
	ThrowIfFailed(DirectX::CreateDDSTextureFromFile12(m_d3dDevice.Get(),
		m_d3dCommandList.Get(), woodCrateTex->Filename.c_str(),
...
void CrateApp::BuildPSOs()
{
    ...
    ThrowIfFailed(m_d3dDevice->CreateGraphicsPipelineState(&opaquePsoDesc, IID_PPV_ARGS(&mOpaquePSO)));
}

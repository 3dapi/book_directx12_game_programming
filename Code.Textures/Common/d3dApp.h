...
protected:
    ...
    UINT64                                  m_d3dIndexFence = 0;
	
    Microsoft::WRL::ComPtr<ID3D12CommandQueue> m_d3dCommandQueue;
    Microsoft::WRL::ComPtr<ID3D12CommandAllocator> m_d3dCommandAlloc;
    Microsoft::WRL::ComPtr<ID3D12GraphicsCommandList> m_d3dCommandList;

	static const int FRAME_BUFFER_COUNT = 2;
    Microsoft::WRL::ComPtr<ID3D12Resource> m_d3dBackBuffer[FRAME_BUFFER_COUNT];
    Microsoft::WRL::ComPtr<ID3D12Resource> m_d3dDepthBuffer;
    int m_d3dIndexBackBuffer = 0;
